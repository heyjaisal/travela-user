...
const BlogCard = ({ blog, onDelete }) => {
  ...
  return (
    <div className="relative p-4 border rounded-lg flex flex-col md:flex-row gap-4 bg-white shadow-sm hover:shadow-md transition-all mb-4 cursor-pointer" onClick={handleClick}>
      <img
